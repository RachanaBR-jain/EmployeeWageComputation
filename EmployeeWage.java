...
//<<<<<<< UC14-TotalWageWhenQuriedByEmployee
...
//>>>>>>> master
	...
	public void computeEmpWage() {
		for(int i=0;i<companyEmpWageList.size();i++)
		{
			...
			companyEmpWage.setTotalEmpWage(this.computeEmpWage(companyEmpWage)); //this will call parameterised computeEmpWage and return
	...
	public static void main(String[] args) {
		...
		System.out.println("Total Wage for BigBazaar : "+empwage.getTotalWage("Vishal_mart"));
		System.out.println("Total Wage for VishalMegaMart : "+empwage.getTotalWage("Relaience"));
